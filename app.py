...
def index():
    if request.method == 'POST':
        ...
        return render_template('index.html', prediction='Your prediction result here')
...
def predict_values(height_inch, Weight, Age, Gender):
    ...
    Bmi_score_decoded      =      predictions[0][17]

    
    return Bmi, body_fat,Neck, Chest,Abdomen, Hip, Thigh, Knee, Ankle, Biceps, Forearm,Wrist, Bmi_score, lean_body_mass, fat_mass,fat_type,skeleton_mass_muscle_kg,Bmi_score_decoded
...
if st.sidebar.button("Predict"):
    try:
        ...
        fat_type, skeleton_mass_muscle_kg,Bmi_score_decoded = results
        ...
        st.success(f"Predicted Bmi_score_decoded :{Bmi_score_decoded}")
